...
-   Script: [`get_chirps.py`](https://github.com/sylvainschmitt/DownClim/blob/main/scripts/get_chirps.py)
...
[**CHIRPS 2.0**](https://www.chc.ucsb.edu/data/chirps)**: Rainfall Estimates from Rain Gauge and Satellite Observations**
...
[**TMF V2.1.1**](https://forobs.jrc.ec.europa.eu/TMF)**: Tracking long-term (1990-2022) deforestation and degradation in tropical moist forests**
