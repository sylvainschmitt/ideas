...
list.files("data", pattern = ".csv", full.names = TRUE) %>% 
  ...
  gather(variable, value, -STATION, -DATE, -LATITUDE, -LONGITUDE, -ELEVATION, -NAME) %>% 
  ggplot(aes(DATE, value/10, col = NAME)) +
  geom_line() +
