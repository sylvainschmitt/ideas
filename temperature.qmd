...
To account for spatial autocorrelation, we took advantage of a method including spatial autocorrelation in model error (CAR, conditional autoregression see note below). We found no significant effect of deforestation on temperature accounting for spatial autoccorelation.
